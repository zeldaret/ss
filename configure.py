...
def nw4rLib(lib_name, objects, extra_cflags=[], mw_version="Wii/1.3"):
    return {
        "lib": lib_name,
        "mw_version": mw_version,  # most seem to be around 1.2, snd is 1.6
...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "d/snd/d_snd_actors.cpp"),

...
public:
    ...
    static void spawnItem(u16 item, u32 room, mVec3_c *pos, const mAng3_c &rot, u32 params, u32 arg);
    static void spawnDrop(u16 item, u32 room, mVec3_c *pos, const mAng3_c &rot);

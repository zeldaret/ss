...
class SeqPlayer : public BasicPlayer, public DisposeCallback, public SoundThread::PlayerCallback {
public:
...
public:
    ...
    f32 GetBaseTempo() const {
        return mTempoRatio * (mParserParam.timebase * mParserParam.tempo) / 60000.0f;
    }

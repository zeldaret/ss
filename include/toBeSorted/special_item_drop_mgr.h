...
public:
    ...
    int giveSpecialDropItem(int specialItemId, int roomid, const mVec3_c &pos, int subtype, mAng rot, s32 unused);
    bool spawnSpecialDropItem(int specialItemId, int roomid, const mVec3_c &pos, int subtype, mAng rot);
};

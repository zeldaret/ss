...
int dThpPlayer_c::draw() {
    dSys::setClearColor(mColor(0xFF));
...
extern "C" {
    s32 fn_802DA220(s32 p1, s32 p2, s32 p3, s32 p4, s32 p5);
}
...
extern "C" {
    extern f32 lbl_80575168;
    extern f32 lbl_80575148;
}

static const u8 SPECIAL_TYPES[] = {0x7A, 0x78, 0x78};

void dThpPlayer_c::reallyExecute() {
    if (mDvdCallback != nullptr && mDvdCallback->mStatus != 0 && mFilenameSet) {
        // NONMATCHING, it's missing a useless branch
        if (mSetupDone) {
            return;
        }
        ...
        f32 b = lbl_80575148;
        f32 a = lbl_80575168;
        mScreen.setVideoDimensions(mVideoComponent.xSize, (mVideoComponent.ySize * (a / b)));
...
extern "C" s32 fn_80273B50(s32 p1, s32 p2, s32 p3, s32 p4, s32 p5) {
    nw4r::ut::LC::Lock();
    s32 result = fn_802DA220(p1, p2, p3, p4, p5);
    nw4r::ut::LC::Unlock();
    return result;
}
